...
See the "Plotting Samples" vignette for more advanced plot options, or
...
plot(dataset, chemshift_range = c(3.5,3.8)) +
    ggplot2::geom_line(
        data = tidy(dataset, chemshift_range = c(3.5,3.8), columns =  character(0), matrix_name = "data_1r_baseline"),
        mapping = ggplot2::aes(x = chemshift, y = intensity, color = NMRExperiment)
    ) + ggplot2::facet_wrap(~NMRExperiment, ncol = 1)
```
