...
regions_basel_corr <- nmr_integrate_regions(dataset_norm, pyroglutamic_acid, fix_baseline = TRUE)
print(regions_basel_corr)
regions_basel_not_corr <- nmr_integrate_regions(dataset_norm, pyroglutamic_acid, fix_baseline = FALSE)
print(regions_basel_not_corr)
```
...
## Getting the spèctra and manipulating it manually
