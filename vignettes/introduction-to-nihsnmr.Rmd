...
```
pipeline_example <- system.file("pipeline-rmd", "pipeline_example.R", package = "NIHSnmr")
...
The `NIHSnmr` package offers the possibility to extract additional diagnostic
