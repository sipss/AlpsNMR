...
(note that both columns have the same column name to match the metadata 
...
diagnostic information with `nmr_diagnose(dataset)`. For now, this 
feature is only used on the normalization to explore the normalization 
factors applied to each sample:
